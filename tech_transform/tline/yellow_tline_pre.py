...
def transform_tline_pre(df, file_name, table_name):
    try:
        # Drop columns with all NaN values
        df = df.dropna(axis=1, how='all')
        
        # Apply solar-specific transformations
        transformed_df = tline_preestimation_transformation(df, file_name)
...
def tline_preestimation_transformation(df, file_name):
    """
