...
def transform_wind_pre(df, file_name, table_name):
    try:
        # Drop columns with all NaN values
        df = df.dropna(axis=1, how='all')
        
        # Apply solar-specific transformations
        transformed_df = wind_preestimation_transformation(df, file_name)
...
def wind_preestimation_transformation(df, file_name):
    """
